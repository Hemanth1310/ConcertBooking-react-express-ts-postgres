...
const HeroComponent = ({concerts}: Props) => {
  ...
  return (
  <div className='w-full overflow-hidden relative transition-opacity duration-1000 ease-in-out md:mt-5 md:rounded-2xl'>
        ...
        <div >
          <div className='absolute z-10 inset-0 bg-black/40 '/>
            <div className="relative z-20 h-full flex flex-col items-center text-white p-4">
                ...
                <div className='text-2xl font-extralight'>{concert.description}</div>
