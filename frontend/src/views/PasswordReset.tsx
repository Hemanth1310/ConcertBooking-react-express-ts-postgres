...
const PasswordReset = () => {
  ...
  return (
     <div className="flex px-5 md:px-0 flex-col w-full h-full mt-5 items-center justify-center">
        <div className='w-full md:w-1/2 py-10 border-2 px-5 flex flex-col items-center'>
             <h1 className="text-2xl md:text-3xl font-bold font-mono py-5">
                ...
                {!isValidated? <div className='w-full flex flex-col md:flex-row  gap-5'>
                                    <div className='flex flex-col gap-2 flex-1'>
                                        ...
                                        <button onClick={handleValidation} className='bg-brand w-50 text-white text-xl p-3 rounded-2xl hover:opacity-75'>Save Changes</button>
                                    </div>   
